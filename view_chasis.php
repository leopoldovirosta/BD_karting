...
?>
        <tr<?php if ($rowCount % 2 == 0) echo " class='alt'" ?>>
            ...
            <td>
                <img src="<?php echo IMAGE_LOGOS_MARCAS_DIRECTORY . ($chasi->getValueEncoded('logo_marca') ?: 'default.jpg') ?>" class="foto foto-click" onclick="openModal(this.src, this.alt)" alt="Logo <?php echo $chasi->getValueEncoded('nombre_marca') ?>" />
            </td>
            ...
            <td>
                <img src="<?php echo IMAGE_CHASIS_DIRECTORY . ($chasi->getValueEncoded('foto_chasis') ?: 'default.jpg') ?>" class="foto foto-click" onclick="openModal(this.src, this.alt)" alt="Foto <?php echo $chasi->getValueEncoded('modelo_chasis') ?>" />
            </td>
        </tr>
<?php
    endforeach;
